...
impl Monde {
    ...
    */
    ...
    pub fn reproduction(&mut self) {
        ...
        let mut enfant = Individu::clone(&individu);
        enfant.mutation();
        self.individus.push(enfant);
    }

    pub fn mort(&mut self) {
        self.individus.remove(self.pire_individu() as usize);
    }
